...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buttonAddTask": () => (/* binding */ buttonAddTask),
/* harmony export */   "clearAllCompleted": () => (/* binding */ clearAllCompleted),
/* harmony export */   "inputAddTask": () => (/* binding */ inputAddTask),
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _getDomElements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getDomElements.js */ "./src/getDomElements.js");
...
class Task {
  ...
  updateList() {
    ...
    _getDomElements_js__WEBPACK_IMPORTED_MODULE_0__.tasksList.innerHTML = '';
    ...
    Task.tasks.forEach((task) => {
      if (task.completed === true) {
        _getDomElements_js__WEBPACK_IMPORTED_MODULE_0__.tasksList.insertAdjacentHTML('beforeend', `
        <div class='task-item'>
...
/* harmony import */ var _getDomElements_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getDomElements.js */ "./src/getDomElements.js");




new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"]().updateList();

_getDomElements_js__WEBPACK_IMPORTED_MODULE_2__.buttonAddTask.addEventListener('click', () => {
  new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"](_getDomElements_js__WEBPACK_IMPORTED_MODULE_2__.inputAddTask.value).addTask();
  _getDomElements_js__WEBPACK_IMPORTED_MODULE_2__.inputAddTask.value = '';
  _getDomElements_js__WEBPACK_IMPORTED_MODULE_2__.inputAddTask.focus();
});

_getDomElements_js__WEBPACK_IMPORTED_MODULE_2__.clearAllCompleted.addEventListener('click', () => {
  new _task_js__WEBPACK_IMPORTED_MODULE_1__["default"]().clearComplete();
});
